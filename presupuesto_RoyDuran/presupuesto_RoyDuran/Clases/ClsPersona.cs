...
namespace presupuesto_RoyDuran.Clases
{
    ...
    {
        public static void registrarPersonaUsuario(string ced, string nom, string Apellido1, string Apellido2, 
            string Direccion, string Telefono, string emailPersona, string email, string clave, int tipo_usuario)
        {
            ...
            comando.Parameters.Add("@Nombre", SqlDbType.Int).Value = nom;
